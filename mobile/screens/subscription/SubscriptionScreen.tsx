    ...
    return (
      <SafeAreaView>
        ...
        <Layout style={{ padding: 15, marginBottom: 15 }}>
          <Text appearance="default" category="h2" style={{ marginBottom: 15 }}>Add Card</Text>
          <AddPaymentCardForm onFormValueChange={() => { return; }} />
          <Button style={{ backgroundColor: PALETTE.primary, borderColor: PALETTE.primary, marginTop: 20 }}> Save Card</Button>
        </Layout>
      </SafeAreaView>
    );
  }
